...
class InfoQ(RedisCrawlSpider):
    ...
    rules = (
        ...
        Rule(LxmlLinkExtractor(allow=(r'infoq\.com/cn/[a-z]+/.+',)),callback='parse_item'),#follow=True
    ...
    def parse_item(self, response):
        ...
        item['pub_time'] = response.xpath('//*[@id="content"]/span/text()').re_first('\d{4}年\d+月\d+日')
        item['content_code'] = ''.join(response.xpath('//*[@id="content"]//div/p//text()').extract())
